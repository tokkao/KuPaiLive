...
public abstract class EaseChatRow extends LinearLayout {
    ...
    protected CircularImage userAvatarView;
    ...
    private void initView() {
        ...
        userAvatarView = (CircularImage) findViewById(R.id.iv_userhead);
    ...
    private void setUpBaseView() {
        ...
        if(userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                ...
                //wanghk 2019-07-30 modify begin /des:modify user avatar
                String headUrl = message.getStringAttribute(EaseConstant.EXTRA_USER_MY_HEAD,"");
              //  Glide.with(context).load(headUrl).placeholder(R.drawable.ease_default_avatar).into(userAvatarView);
                if("".equals(headUrl) || headUrl == null){
                    userAvatarView.setImageResource(R.drawable.ease_default_avatar);
                }else {
                    Log.e(TAG, "setUpBaseView: my headUrl = "+headUrl );

                    Picasso.get().load(headUrl).error(R.drawable.ease_default_avatar).placeholder(R.drawable.ease_default_avatar).into(userAvatarView);
...
//                Glide.with(context).load(message.getStringAttribute(EaseConstant.EXTRA_USER_OTHER_HEAD,"")).placeholder(R.drawable.ease_default_avatar).into(userAvatarView);
                String headUrl = message.getStringAttribute(EaseConstant.EXTRA_USER_OTHER_HEAD, "");

                Log.e(TAG, "setUpBaseView: other headUrl = "+headUrl );
                if("".equals(headUrl) || headUrl == null){
                    userAvatarView.setImageResource(R.drawable.ease_default_avatar);
                }else {
                    Picasso.get().load(headUrl).error(R.drawable.ease_default_avatar).placeholder(R.drawable.ease_default_avatar).into(userAvatarView);
                ...
                usernickView.setText(message.getStringAttribute(EaseConstant.EXTRA_USER_OTHER_NAME,""));
                //wanghk 2019-07-30 modify end
            }
        }
