...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected String toChatUserHead;
    protected String myUserHead;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return createViewWithRoaming(inflater,container,savedInstanceState,true);
    }

    public View createViewWithRoaming(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState, boolean roaming) {
        isRoaming = roaming;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        toChatNickName = fragmentArgs.getString(EaseConstant.EXTRA_USER_OTHER_NAME);
        toChatUserHead = fragmentArgs.getString(EaseConstant.EXTRA_USER_OTHER_HEAD);
        Log.e(TAG, "onActivityCreated: toChatUserHead = "+toChatUserHead );
        myUserHead = fragmentArgs.getString(EaseConstant.EXTRA_USER_MY_HEAD);
...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.my_icon_delete);
        } else {
    ...
    protected void onConversationInit(){
        EMLog.e(TAG,toChatUsername+"   "+chatType);
    ...
    protected void onMessageListInit(){
        messageList.init(toChatUsername, toChatUserHead,myUserHead,chatType, chatFragmentHelper != null ?
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        for (EMMessage message : messages) {
          ...
          //  message.setAttribute(EaseConstant.EXTRA_USER_OTHER_NAME,toChatNickName);
          //  message.setAttribute(EaseConstant.EXTRA_USER_OTHER_HEAD,toChatUserHead);
...
//            EMLog.e(TAG, "----------------------------------sendAtMessage");
            sendAtMessage(content);
        }else{
//            EMLog.e(TAG, "----------------------------------"+toChatUsername);
    ...
    protected void sendMessage(EMMessage message){
        ...
        EMLog.e(TAG, "----------------sendMessage------------------");
        EMLog.e(TAG, "-----------------------------chatType-----"+chatType);
        // 设置消息的扩展属性，携带头像
        Log.e("放置自己头像====", myUserHead);
        //message.setAttribute(EaseConstant.EXTRA_USER_MY_HEAD,myUserHead);
    ...
    protected EMCallBack messageStatusCallback = new EMCallBack() {
        ...
        public void onError(int code, String error) {
            EMLog.e(TAG, "onError: " + code + ", error: " + error);
            if(isMessageListInited) {
                messageList.refresh();
            }
        }
