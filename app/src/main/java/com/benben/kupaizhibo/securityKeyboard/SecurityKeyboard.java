package com.benben.kupaizhibo.securityKeyboard;
...
import com.benben.kupaizhibo.utils.DisplayUtils;
...
public class SecurityKeyboard extends PopupWindow {
    ...
    public SecurityKeyboard(final View parentLayout
            , SecurityConfigure securityConfigure
            , Context context
            , final View ShowPopupWindow) {
        super(context);
